...
c1_strategy_dict = {"A": "Rock", "B": "Paper", "C": "Scissors"}
c2_strategy_dict = {"X": "Rock", "Y": "Paper", "Z": "Scissors"}
...
with open("input.txt") as file:
    while True:
        ...
        line = line.strip()
        line = line.split()
        opponent = c1_strategy_dict[line[0]]
        me = c2_strategy_dict[line[1]]
        total += shape_points[me]
        if winner_dict[me] == opponent: #win
            total += win_points
        elif me == opponent: #tie
            total += draw_points
        else:
            total += loss_points
    print(total)
...
c1_strategy_dict = {"A": "Rock", "B": "Paper", "C": "Scissors"}
c2_strategy_dict = {"X": "Lose", "Y": "Draw", "Z": "Win"}
shape_points = {"Rock": 1, "Paper": 2, "Scissors": 3}
winner_dict = {"Rock": "Scissors", "Paper": "Rock", "Scissors": "Paper"}
loser_dict = {v:k for k,v in winner_dict.items()}
...
with open("input.txt") as file:
    while True:
        ...
        if me == "Draw":
            ...
            me = loser_dict[opponent]
        else:
            me = winner_dict[opponent]
        total += shape_points[me]
        if winner_dict[me] == opponent: #win
            total += win_points
        elif me == opponent: #tie
