...
with open("input.txt") as f:
    ...
    while True:
        ...
        elf_1_min, elf_1_max, elf_2_min, elf_2_max = int(elf_1_min), int(elf_1_max), int(elf_2_min), int(elf_2_max)
...
with open("input.txt") as f:
    ...
    while True:
        ...
        elf_2_min, elf_2_max = elf_2.split("-")
        elf_1_min, elf_1_max, elf_2_min, elf_2_max = int(elf_1_min), int(elf_1_max), int(elf_2_min), int(elf_2_max)
        if (elf_1_min <= elf_2_min <= elf_1_max) or (elf_1_min <= elf_2_max <= elf_1_max) or (
            elf_2_min <= elf_1_min <= elf_2_max) and (elf_2_min <= elf_1_max <= elf_2_max):
            overlaps += 1
    print(overlaps)
